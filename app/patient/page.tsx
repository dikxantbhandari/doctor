...
export default function PatientDashboard() {
  ...
  const handleSendMessage = () => {
    ...
    setTimeout(() => {
      ...
      setMessages((prev) => [...prev.filter((msg) => !msg.thinking), aiResponse])
    }, 1500)
  }
      ...
      <div className="relative z-10 flex flex-col h-full max-w-4xl mx-auto w-full px-4">
        <header className="py-4 border-b border-purple-800/30 backdrop-blur-sm">
          <div className="flex items-center justify-between">
            <Badge variant="outline" className="bg-purple-900/50 text-purple-200 border-purple-500/30 px-3 py-1">
              <Sparkles className="h-3 w-3 mr-1 text-purple-300" />
              AI Therapist Session
            </Badge>
            <h1 className="text-2xl font-bold text-center bg-clip-text text-transparent bg-gradient-to-r from-purple-200 to-purple-400">
              MindfulAI Therapist
            </h1>
            <Badge variant="outline" className="bg-green-900/50 text-green-200 border-green-500/30 px-3 py-1">
              Online
            </Badge>
          </div>
        </header>
